 ...
 */
final class Version20251128134548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, course_id INT DEFAULT NULL, session_name VARCHAR(255) NOT NULL, nb_runner INT NOT NULL, INDEX IDX_D044D5D4591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD establishment_id INT DEFAULT NULL, DROP lastname, DROP first_name');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD lastname VARCHAR(255) NOT NULL, ADD first_name VARCHAR(255) NOT NULL, DROP establishment_id');
    }
}
