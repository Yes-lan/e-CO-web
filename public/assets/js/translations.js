...
const translations = {
    fr: {
        ...
        'courses.create_course': 'Cr├®er une course',
        'courses.error_loading': 'Erreur de chargement des courses',
        'courses.messages.created': 'Course cr├®├®e avec succ├¿s !',
        'courses.messages.deleted': 'Course supprim├®e avec succ├¿s !',
        'courses.messages.confirm_delete': '├ètes-vous s├╗r de vouloir supprimer la course "%name%" ?',
        'courses.messages.error_create': 'Erreur lors de la cr├®ation',
        'courses.messages.error_delete': 'Erreur lors de la suppression',
        'courses.modal.create_title': 'Cr├®er une Nouvelle Course',
        'courses.modal.name_label': 'Nom de la course',
        'courses.modal.parcours_label': 'Parcours associ├®',
        'courses.modal.parcours_select': 'S├®lectionner un parcours...',
        'courses.modal.nb_runners_label': 'Nombre de coureurs',
        'courses.modal.cancel': 'Annuler',
        'courses.modal.create': 'Cr├®er',
        ...
        'parcours.status.in_creation': 'En cours de cr├®ation',
